                ...
                mAuth.createUserWithEmailAndPassword(Email, Password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Log.e("Driver Registration","sign up error");
                            ...
                            mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(DriverLoginActivity.this, "Registered. Please verify email", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                Log.e("Driver Registration","user id null exception");
                            }catch (Exception e){
                                e.printStackTrace();
                            }
                        }
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.signInWithEmailAndPassword(Email, Password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Log.e("Driver Login","sign in error");
